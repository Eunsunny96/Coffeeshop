...
<span>
  ...
  <h1> 😯 개선할 점 </h1>
  - 사용자 입장으로 생각할 때 필요한 기능이 충분치 않음<br>
  - 관리자 기능에 대해 더 생각 후 구현<br>
  - 결제 모듈, 배송등 구현<br>
  - 데이터 로딩 시간이 길어 더 짧게 가져올 수 있는 방법 모색<br>
  - 설계 공부, 유지 보수를 더 편하게 기능 설계
  
  <h1> 🧐 개발 후기 </h1>
   - 혼자 모든걸 생각하고 개발하기에 흥미롭고 내 스타일대로 개발 가능<br>
   - 혼자 찾아서 해결하는 만큼 공부가 더 됨<br>
   - 전반적인 수정해야 할 때 설계의 중요성을 깨달음<br>
   - 구매 사이트의 전반적인 기능을 알게 됨
